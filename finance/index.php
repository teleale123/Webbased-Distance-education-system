        ...
        <link href="csss/startmin.css" rel="stylesheet"/>
            <center>
             <div id="page-wrapper">
            	...
            	<?php
$query = mysql_query("select distinct status,unread,payment,type from payment_table where status='yes' and unread='yes' and payment='check'")or die(mysql_error());
while($row=mysql_fetch_array($query))
{
$p=$row['type'];
$query1 = mysql_query("select * from payment_table where status='yes' and unread='yes' and payment='check' and type='$p'")or die(mysql_error());
